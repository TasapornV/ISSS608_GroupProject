...
### Clustering using dendextend & heatmap - Description & dwelling_type
...
### Clustering using dendextend & heatmap - Aggregated demand at description level
...
```{r}
#load lib
pacman::p_load(scales, viridis, lubridate, gridExtra, knitr, data.table, ggthemes, CGPfunctions, ggHoriPlot, gapminder, gganimate, ggbraid, ggstatsplot, ggiraph, plotly, performance, nortest, patchwork, ggdist, tidyverse)
```
...
#p_roller <- xts(x = data$count, order.by = data$datetime)
