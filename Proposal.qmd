...
To address this challenge, we build this RShinny app to provide relevant stakeholders with means of analyzing and explore the large dataset using applicable analytics models. Also, we want to help the users digest the information about the Singapore energy market easily through visualizations.
